...
@inline ∂p∂x(i, j, k, grid, tvar::Entropy, densities, tracers) = ∂xᶠᵃᵃ(i, j, k, grid, diagnose_p, tvar, densities, tracers)
@inline ∂p∂y(i, j, k, grid, tvar::Entropy, densities, tracers) = ∂yᵃᶠᵃ(i, j, k, grid, diagnose_p, tvar, densities, tracers)
@inline ∂p∂z(i, j, k, grid, tvar::Entropy, densities, tracers) = ∂zᵃᵃᶠ(i, j, k, grid, diagnose_p, tvar, densities, tracers)
