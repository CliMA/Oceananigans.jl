...
@inline thermal_expansionᶠᶜᶜ(i, j, k, grid, eos, θ, sᴬ) = thermal_expansion(ℑxᶠᶜᶜ(i, j, k, grid, θ), ℑxᶠᶜᶜ(i, j, k, grid, sᴬ), Zᶜᶜᶜ(i, j, k, grid), eos)
@inline thermal_expansionᶜᶠᶜ(i, j, k, grid, eos, θ, sᴬ) = thermal_expansion(ℑyᶜᶠᶜ(i, j, k, grid, θ), ℑyᶜᶠᶜ(i, j, k, grid, sᴬ), Zᶜᶜᶜ(i, j, k, grid), eos)
@inline thermal_expansionᶜᶜᶠ(i, j, k, grid, eos, θ, sᴬ) = thermal_expansion(ℑzᶜᶜᶠ(i, j, k, grid, θ), ℑzᶜᶜᶠ(i, j, k, grid, sᴬ), Zᶜᶜᶠ(i, j, k, grid), eos)

@inline haline_contractionᶜᶜᶜ(i, j, k, grid, eos, θ, sᴬ) = haline_contraction(θ_and_sᴬ(i, j, k, θ, sᴬ)..., Zᶜᶜᶜ(i, j, k, grid), eos)
@inline haline_contractionᶠᶜᶜ(i, j, k, grid, eos, θ, sᴬ) = haline_contraction(ℑxᶠᶜᶜ(i, j, k, grid, θ), ℑxᶠᶜᶜ(i, j, k, grid, sᴬ), Zᶜᶜᶜ(i, j, k, grid), eos)
@inline haline_contractionᶜᶠᶜ(i, j, k, grid, eos, θ, sᴬ) = haline_contraction(ℑyᶜᶠᶜ(i, j, k, grid, θ), ℑyᶜᶠᶜ(i, j, k, grid, sᴬ), Zᶜᶜᶜ(i, j, k, grid), eos)
@inline haline_contractionᶜᶜᶠ(i, j, k, grid, eos, θ, sᴬ) = haline_contraction(ℑzᶜᶜᶠ(i, j, k, grid, θ), ℑzᶜᶜᶠ(i, j, k, grid, sᴬ), Zᶜᶜᶠ(i, j, k, grid), eos)
