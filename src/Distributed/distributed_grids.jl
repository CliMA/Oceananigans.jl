...
@inline local_grid_constructor(grid::RectilinearGrid, x, y, z, size, halo) = RectilinearGrid(size = size, 
                                                                  halo = halo,
...
@inline local_grid_constructor(grid::LatitudeLongitudeGrid, x, y, z, size, halo) = LatitudeLongitudeGrid(size = size, 
                                                                     halo = halo,
                                                             architecture = grid.architecture,
                                                                longitude = x,
                                                                 latitude = y,
...
function local_grids(arch::MultiArch, grid)
...
@inline local_grids(arch, grid) = grid
