using Oceananigans.Grids: AbstractGrid, Center, Face, znode, ZFlatGrid
...
# Basic functionality
@inline SeawaterPolynomials.ρ′(i, j, k, grid::AbstractGrid, eos, θ, sᴬ) = ρ′(θ_and_sᴬ(i, j, k, θ, sᴬ)..., Zᶜᶜᶜ(i, j, k, grid), eos)
