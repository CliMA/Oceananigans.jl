...
IdealGas(FT=Float64; Rᵈ=Rᵈ_air, Rᵛ=Rᵛ_air, cₚ=cₚ_dry, cᵥ=cᵥ_dry, κ=κᵈ, γ=γᵈ,
                     T₀=T₀_air, p₀=p₀_air, ρ₀=ρ₀_air, s₀=0) =
    IdealGas{FT}(Rᵈ, Rᵛ, cₚ, cᵥ, κ, γ, T₀, p₀, ρ₀, s₀)

####
#### Buoyancy term
####

@inline buoyancy_perturbation(i, j, k, grid, g, mp, ρᵈ, C) = g * ρᵐ(i, j, k, grid, mp, ρᵈ, C)
