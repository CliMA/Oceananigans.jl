...
fill_west_and_east_halo!(u, west_bc::OBC, east_bc::OBC, arch, dep, grid, args...; kwargs...) =
    (NoneEvent(), launch!(arch, grid, :yz, set_west_and_east_u!, u, west_bc, east_bc, grid, args...; dependencies=dep, kwargs...))

fill_south_and_north_halo!(v, south_bc::OBC, north_bc::OBC, arch, dep, grid, args...; kwargs...) =
    (NoneEvent(), launch!(arch, grid, :xz, set_south_and_north_v!, v, south_bc, north_bc, grid, args...; dependencies=dep, kwargs...))
