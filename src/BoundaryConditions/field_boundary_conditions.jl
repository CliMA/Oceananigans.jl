...
default_prognostic_bc(::RightFaceConnected, ::Center, default)  = default.boundary_condition
...
default_prognostic_bc(::RightFaceConnected, ::Face, default) = ImpenetrableBoundaryCondition()
...
default_prognostic_bc(::RightFaceConnected, ::Nothing, default) = nothing
...
_default_auxiliary_bc(::RightFaceConnected, ::Face) = nothing
