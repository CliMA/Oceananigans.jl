...
"""
@kernel function _apply_x_bcs!(Gc, loc, grid, west_bc, east_bc, args::Vararg{T, N}) where {T, N}
...
"""
@kernel function _apply_y_bcs!(Gc, loc, grid, south_bc, north_bc, args::Vararg{T, N}) where {T, N}
...
"""
@kernel function _apply_z_bcs!(Gc, loc, grid, bottom_bc, top_bc, args::Vararg{T, N}) where {T, N}
