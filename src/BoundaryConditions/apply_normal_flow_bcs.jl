...
function fill_west_halo!(u, bc::NFBC, arch, grid, clock, state)
...
function fill_east_halo!(u, bc::NFBC, arch, grid, clock, state)
...
function fill_south_halo!(v, bc::NFBC, arch, grid, clock, state)
...
function fill_north_halo!(v, bc::NFBC, arch, grid, clock, state)
...
function fill_bottom_halo!(w, bc::NFBC, arch, grid, clock, state)
...
function fill_top_halo!(w, bc::NFBC, arch, grid, clock, state)
