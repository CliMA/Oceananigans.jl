...
"""
    fill_halo_regions!(fields, arch, grid)
...
"""
function fill_halo_regions!(fields::NamedTuple, arch, grid, args...)
    for field in fields
        fill_halo_regions!(field, arch, grid, args...)
    end
    return nothing
end

fill_halo_regions!(field, arch, grid, args...) =
    fill_halo_regions!(field.data, field.boundary_conditions, arch, grid, args...)
