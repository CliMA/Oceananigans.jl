...
####
#### If a distributed grid, stay there!
####

function on_architecture(new_arch::AbstractSerialArchitecture, old_grid::DistributedLatitudeLongitudeGrid) 
    child_arch = child_architecture(new_arch)
    old_properties = (old_grid.Δλᶠᵃᵃ, old_grid.Δλᶜᵃᵃ, old_grid.λᶠᵃᵃ,  old_grid.λᶜᵃᵃ,
                      old_grid.Δφᵃᶠᵃ, old_grid.Δφᵃᶜᵃ, old_grid.φᵃᶠᵃ,  old_grid.φᵃᶜᵃ,
                      old_grid.z,
    ...
    return LatitudeLongitudeGrid{TX, TY, TZ}(new_distributed_arch,
                                             old_grid.Nx, old_grid.Ny, old_grid.Nz,
                                             old_grid.Hx, old_grid.Hy, old_grid.Hz,
                                             old_grid.Lx, old_grid.Ly, old_grid.Lz,
                                             new_properties...,
...
function on_architecture(new_arch::AbstractSerialArchitecture, old_grid::DistributedRectilinearGrid)
    child_arch = child_architecture(new_arch)
    old_properties = (old_grid.Δxᶠᵃᵃ, old_grid.Δxᶜᵃᵃ, old_grid.xᶠᵃᵃ, old_grid.xᶜᵃᵃ,
                      old_grid.Δyᵃᶠᵃ, old_grid.Δyᵃᶜᵃ, old_grid.yᵃᶠᵃ, old_grid.yᵃᶜᵃ,
                      old_grid.z)
    ...
    return RectilinearGrid{TX, TY, TZ}(new_distributed_arch,
                                       old_grid.Nx, old_grid.Ny, old_grid.Nz,
                                       old_grid.Hx, old_grid.Hy, old_grid.Hz,
                                       old_grid.Lx, old_grid.Ly, old_grid.Lz,
                                       new_properties...)
...
function on_architecture(new_arch::AbstractSerialArchitecture, grid::DistributedOrthogonalSphericalShellGrid)
