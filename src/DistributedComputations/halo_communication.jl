...
@inline communication_side(::Val{fill_west_and_east_halo!})   = :west_and_eas
...
@inline communication_side(::Val{fill_west_halo!})   = :wes
@inline communication_side(::Val{fill_east_halo!})   = :eas
