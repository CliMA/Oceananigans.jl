...
@inline xnode(i, ibg::IBG, LX) = xnode(i, ibg.underlying_grid, LX)
@inline ynode(j, ibg::IBG, LY) = ynode(j, ibg.underlying_grid, LY)
@inline znode(k, ibg::IBG, LZ) = znode(k, ibg.underlying_grid, LZ)

@inline xnode(i, j, k, ibg::IBG, LX, LY, LZ) = xnode(i, j, k, ibg.underlying_grid, LX, LY, LZ)
