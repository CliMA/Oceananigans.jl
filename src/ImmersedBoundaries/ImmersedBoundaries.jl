...
@inline λnode(i, ibg::IBG, LX; kwargs...) = λnode(i, ibg.underlying_grid, LX; kwargs...)
@inline φnode(j, ibg::IBG, LY; kwargs...) = φnode(j, ibg.underlying_grid, LY; kwargs...)
...
@inline λnode(i, j, k, ibg::IBG, LX, LY, LZ; kwargs...) = λnode(i, j, k, ibg.underlying_grid, LX, LY, LZ; kwargs...)
@inline φnode(i, j, k, ibg::IBG, LX, LY, LZ; kwargs...) = φnode(i, j, k, ibg.underlying_grid, LX, LY, LZ; kwargs...)
