...
# @inline conditional_derx_f(LY, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(c, LY, LZ, i, j, k, ibg) || solid_node(c, LY, LZ, i-1, j, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
# @inline conditional_derx_c(LY, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(f, LY, LZ, i, j, k, ibg) || solid_node(f, LY, LZ, i+1, j, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
# @inline conditional_dery_f(LX, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(LX, c, LZ, i, j, k, ibg) || solid_node(LX, c, LZ, i, j-1, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
# @inline conditional_dery_c(LX, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(LX, f, LZ, i, j, k, ibg) || solid_node(LX, f, LZ, i, j+1, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
# @inline conditional_derz_f(LX, LY, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(LX, LY, c, i, j, k, ibg) || solid_node(LX, LY, c, i, j, k-1, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
# @inline conditional_derz_c(LX, LY, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(solid_node(LX, LY, f, i, j, k, ibg) || solid_node(LX, LY, f, i, j, k+1, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))

# ∂xᶠᶜᶜ(i, j, k, ibg::IBG, args...) = conditional_derx_f(c, c, i, j, k, ibg, _∂xᶠᶠᶜ, args...)
# ∂xᶠᶜᶠ(i, j, k, ibg::IBG, args...) = conditional_derx_f(c, f, i, j, k, ibg, _∂xᶠᶠᶜ, args...)
# ∂xᶠᶠᶜ(i, j, k, ibg::IBG, args...) = conditional_derx_f(f, c, i, j, k, ibg, _∂xᶠᶠᶜ, args...)
# ∂xᶠᶠᶠ(i, j, k, ibg::IBG, args...) = conditional_derx_f(f, f, i, j, k, ibg, _∂xᶠᶠᶜ, args...)
