...
@inline rnode(i::AbstractArray, j::AbstractArray, k, ibg::IBG, ℓx, ℓy, ℓz) = rnode(i, j, k, ibg.underlying_grid, ℓx, ℓy, ℓz)
...
xnodes(ibg::IBG, ::Nothing; kwargs...) = 1:1
ynodes(ibg::IBG, ::Nothing; kwargs...) = 1:1
