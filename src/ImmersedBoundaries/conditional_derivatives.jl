...
@inline conditional_x_derivative_f(LY, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(c, LY, LZ, i, j, k, ibg) | external_node(c, LY, LZ, i-1, j, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
@inline conditional_x_derivative_c(LY, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(f, LY, LZ, i, j, k, ibg) | external_node(f, LY, LZ, i+1, j, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
@inline conditional_y_derivative_f(LX, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(LX, c, LZ, i, j, k, ibg) | external_node(LX, c, LZ, i, j-1, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
@inline conditional_y_derivative_c(LX, LZ, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(LX, f, LZ, i, j, k, ibg) | external_node(LX, f, LZ, i, j+1, k, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
@inline conditional_z_derivative_f(LX, LY, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(LX, LY, c, i, j, k, ibg) | external_node(LX, LY, c, i, j, k-1, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
@inline conditional_z_derivative_c(LX, LY, i, j, k, ibg::IBG{FT}, deriv, args...) where FT = ifelse(external_node(LX, LY, f, i, j, k, ibg) | external_node(LX, LY, f, i, j, k+1, ibg), zero(FT), deriv(i, j, k, ibg.grid, args...))
