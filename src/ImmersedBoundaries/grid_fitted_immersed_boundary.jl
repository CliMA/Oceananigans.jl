...
# ccc, ffc, fcf
 @inline _viscous_flux_ux(i, j, k, ibg::GFIBG, disc, closure, immersed_bcs::VelocitiesNamedTuple, args...) = conditional_flux_ccc(i, j, k, ibg, viscous_flux_ux, disc, closure, args...)
