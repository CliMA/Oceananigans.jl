...
field `δxf`, assuming both fields are defined on a regular Cartesian grid
...
field `δyf`, assuming both fields are defined on a regular Cartesian grid
...
field `δzf`, assuming both fields are defined on a regular Cartesian grid
