...
@inline function Gu_coriolis(g::RegularCartesianGrid, v, f, i, j, k) =  0.5 * f * (avgy_f2c(g, v, decmod1(i, g.Nx), j, k) + avgy_f2c(g, v, i, j, k))
@inline function Gv_coriolis(g::RegularCartesianGrid, u, f, i, j, k) = -0.5 * f * (avgx_f2c(g, u, i, decmod1(j, g.Ny), k) + avgx_f2c(g, u, i, j, k))
