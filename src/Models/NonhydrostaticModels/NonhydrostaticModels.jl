...
using Oceananigans.Distributed: DistributedFFTBasedPoissonSolver, reconstruct_global_grid   
using Oceananigans.Distributed: DistributedRegularRectilinearGrid
...
function PressureSolver(arch, local_grid::DistributedRegularRectilinearGrid)
