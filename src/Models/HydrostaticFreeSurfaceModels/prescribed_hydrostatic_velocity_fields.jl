...
function update_prescribed_∂t_σ!(grid::MutableGridOfSomeKind, model,
                                  ::PrescribedFreeSurface, Δt)
...
update_prescribed_∂t_σ!(grid, model, ::PrescribedFreeSurface{<:Field}, Δt) = nothing
