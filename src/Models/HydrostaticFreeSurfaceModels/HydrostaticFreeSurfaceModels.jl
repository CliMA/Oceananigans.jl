...
#FreeSurfaceDisplacementField(velocities, free_surface, grid) = Field{Center, Center, Face}(grid, indices=(:, :, grid.Nz+1))
FreeSurfaceDisplacementField(velocities, free_surface, grid) = Field{Center, Center, Face}(grid)
