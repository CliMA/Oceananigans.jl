...
function iterate_split_explicit!(free_surface, grid, Δτᴮ, weights, ::Val{Nsubsteps}) where Nsubsteps
    ...
    free_surface_kernel!, _        = configure(arch, grid, parameters, _split_explicit_free_surface!)
    barotropic_velocity_kernel!, _ = configure(arch, grid, parameters, _split_explicit_barotropic_velocity!)
