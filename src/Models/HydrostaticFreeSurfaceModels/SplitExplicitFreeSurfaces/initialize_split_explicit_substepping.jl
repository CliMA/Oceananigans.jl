...
# reset the filtered state to zero and reinitialize the barotropic timestepping variables.
...
function initialize_free_surface_state!(free_surface, baroclinic_ts::SplitRungeKutta3TimeStepper, barotropic_ts, stage)
