...
regularize_diffusivity_fields(diffusivities::Tuple) = (diffusivities=diffusivities,)
regularize_diffusivity_fields(diffusivities::NamedTuple) = diffusivities
...
"""
@inline all_model_fields(model) = merge(model.velocities,
                                        model.tracers,
