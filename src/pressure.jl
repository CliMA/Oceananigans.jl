...
####
#### Pressure gradient ∇p terms
####

@inline ∂p∂x(i, j, k, grid, pt::Temperature, gas::IG, pₛ, C) = gas.Rᵈ * ∂xᶠᵃᵃ(i, j, k, grid, C.Θᵐ)
@inline ∂p∂y(i, j, k, grid, pt::Temperature, gas::IG, pₛ, C) = gas.Rᵈ * ∂yᵃᶠᵃ(i, j, k, grid, C.Θᵐ)
@inline ∂p∂z(i, j, k, grid, pt::Temperature, gas::IG, pₛ, C) = gas.Rᵈ * ∂zᵃᵃᶠ(i, j, k, grid, C.Θᵐ)
...
####
#### Pressure perturbation gradient ∇p′
####
