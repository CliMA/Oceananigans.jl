...
function Base.getindex(fts::FieldTimeSeries, time_index::Time)
    ...
    ñ, n₁, n₂ = cpu_safe_interpolating_time_indices(architecture(fts), fts.times, fts.time_indexing, time_index.time)
...
function cpu_safe_interpolating_time_indices(::GPU, times::AbstractVector, time_indexing, t) 
...
function update_field_time_series!(fts::PartlyInMemoryFTS, time_index::Time)
    t = time_index.time
    ñ, n₁, n₂ = cpu_safe_interpolating_time_indices(architecture(fts), fts.times, fts.time_indexing, t)
