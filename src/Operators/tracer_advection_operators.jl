...
"""
@inline function div_uc(i, j, k, grid, u, v, w, c)
    1/Vᵃᵃᶜ(i, j, k, grid) * (δxᶜᵃᵃ(i, j, k, grid, advective_tracer_flux_x, u, c) +
                             δyᵃᶜᵃ(i, j, k, grid, advective_tracer_flux_y, v, c) +
                             δzᵃᵃᶜ(i, j, k, grid, advective_tracer_flux_z, w, c))
end
