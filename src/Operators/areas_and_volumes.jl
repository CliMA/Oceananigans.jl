...
@inline ΔzC(i, j, k, grid::RegularRectilinearOrthogonalGrid) = grid.Δz
@inline ΔzC(i, j, k, grid::VerticallyStretchedRectilinearOrthogonalGrid) = @inbounds grid.ΔzC[k]

@inline ΔzF(i, j, k, grid::RegularRectilinearOrthogonalGrid) = grid.Δz
@inline ΔzF(i, j, k, grid::VerticallyStretchedRectilinearOrthogonalGrid) = @inbounds grid.ΔzF[k]

@inline Δzᵃᵃᶠ(i, j, k, grid::RegularRectilinearOrthogonalGrid) = grid.Δz
@inline Δzᵃᵃᶠ(i, j, k, grid::VerticallyStretchedRectilinearOrthogonalGrid) = @inbounds grid.ΔzC[k]

@inline Δzᵃᵃᶜ(i, j, k, grid::RegularRectilinearOrthogonalGrid) = grid.Δz
@inline Δzᵃᵃᶜ(i, j, k, grid::VerticallyStretchedRectilinearOrthogonalGrid) = @inbounds grid.ΔzF[k]
