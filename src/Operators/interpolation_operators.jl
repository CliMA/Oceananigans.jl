...
@inline getzᴿ(i, j, k, grid, ℓx, ℓy, ℓz, q) = @inbounds ifelse(inactive_node(i, j, idxᴿ(k, ℓx), grid, ℓx, ℓy, flip(ℓz)), q[i, j, idxᴸ(k, ℓz)], q[i, j, idxᴿ(k, ℓz)])
@inline getzᴸ(i, j, k, grid, ℓx, ℓy, ℓz, q) = @inbounds ifelse(inactive_node(i, j, idxᴸ(k, ℓx), grid, ℓx, ℓy, flip(ℓz)), q[i, j, idxᴿ(k, ℓz)], q[i, j, idxᴸ(k, ℓz)])
...
@inline getzᴿ(i, j, k, g, ℓx, ℓy, ℓz, f::F, a...) where F<:Function = ifelse(inactive_node(i, j, idxᴿ(k, ℓx), g, ℓx, ℓy, flip(ℓz)), f(i, j, idxᴸ(k, ℓz), g, a...), f(i, j, idxᴿ(k, ℓz), g, a...))
@inline getzᴸ(i, j, k, g, ℓx, ℓy, ℓz, f::F, a...) where F<:Function = ifelse(inactive_node(i, j, idxᴸ(k, ℓx), g, ℓx, ℓy, flip(ℓz)), f(i, j, idxᴿ(k, ℓz), g, a...), f(i, j, idxᴸ(k, ℓz), g, a...))
