...
const UpwindMDS    = AbstractMultiDimensionalAdvectionScheme{<:Any, <:Any, <:AbstractUpwindBiasedAdvectionScheme} 
const UpwindScheme = Union{AbstractUpwindBiasedAdvectionScheme, UpwindMDS}
