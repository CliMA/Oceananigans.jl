...
@inline function div_𝐯u(i, j, k, grid, advection, U, u)
    return Vᶠᶜᶜ⁻¹(i, j, k, grid) * (δxᶠᵃᵃ(i, j, k, grid, _advective_momentum_flux_Uu, advection, U[1], u) +
...
@inline function div_𝐯v(i, j, k, grid, advection, U, v)
    return Vᶜᶠᶜ⁻¹(i, j, k, grid) * (δxᶜᵃᵃ(i, j, k, grid, _advective_momentum_flux_Uv, advection, U[1], v) +
...
@inline function div_𝐯w(i, j, k, grid, advection, U, w)
    return Vᶜᶜᶠ⁻¹(i, j, k, grid) * (δxᶜᵃᵃ(i, j, k, grid, _advective_momentum_flux_Uw, advection, U[1], w) +
