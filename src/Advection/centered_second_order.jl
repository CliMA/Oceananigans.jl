...
@inline advective_momentum_flux_Wu(i, j, k, grid, ::C2, W, u) = ℑxᶠᵃᵃ(i, j, k, grid, Az_qᶜᶜᵃ, W) * ℑzᵃᵃᶠ(i, j, k, grid, u)
...
@inline advective_momentum_flux_Ww(i, j, k, grid, ::C2, W, w) = ℑzᵃᵃᶜ(i, j, k, grid, Az_qᶜᶜᵃ, W) * ℑzᵃᵃᶜ(i, j, k, grid, w)
