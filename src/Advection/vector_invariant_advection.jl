...
├── vorticity_scheme: WENO{5, Float64, Oceananigans.Utils.BackendOptimizedDivision}(order=9)
├── vorticity_stencil: Oceananigans.Advection.VelocityStencil
├── vertical_advection_scheme: WENO{3, Float64, Oceananigans.Utils.BackendOptimizedDivision}(order=5)
├── kinetic_energy_gradient_scheme: WENO{3, Float64, Oceananigans.Utils.BackendOptimizedDivision}(order=5)
├── divergence_scheme: WENO{3, Float64, Oceananigans.Utils.BackendOptimizedDivision}(order=5)
