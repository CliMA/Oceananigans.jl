...
struct VectorInvariant{N, FT, M, Z, ZS, V, K, D, U} <: AbstractAdvectionScheme{N, FT}
    ...
    kinetic_energy_gradient_scheme :: K  # reconstruction scheme for kinetic energy gradien
    divergence_scheme              :: D  # reconstruction scheme for divergence flux
    upwinding                      :: U  # treatment of upwinding for divergence flux and kinetic energy gradien
...
#####
##### Convenience for WENO Vector Invarian
#####
