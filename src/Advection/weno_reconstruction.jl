...
struct WENO{N, FT, XT, YT, ZT, PP, CA, SI, D} <: AbstractUpwindBiasedAdvectionScheme{N, D, FT}
    ...
    function WENO{N, FT, D}(coeff_xᶠᵃᵃ::XT, coeff_xᶜᵃᵃ::XT,
                            coeff_yᵃᶠᵃ::YT, coeff_yᵃᶜᵃ::YT, 
                            coeff_zᵃᵃᶠ::ZT, coeff_zᵃᵃᶜ::ZT,
                            bounds::PP, buffer_scheme::CA,
                            advecting_velocity_scheme :: SI) where {N, D, FT, XT, YT, ZT, PP, CA, SI}

            return new{N, FT, XT, YT, ZT, PP, CA, SI, D}(coeff_xᶠᵃᵃ, coeff_xᶜᵃᵃ, 
...
const    DivergentWENO{N, FT, XT, YT, ZT, PP, CA, SI} = WENO{N, FT, XT, YT, ZT, PP, CA, SI, true}  where {N, FT, XT, YT, ZT, PP, CA, SI}
const NonDivergentWENO{N, FT, XT, YT, ZT, PP, CA, SI} = WENO{N, FT, XT, YT, ZT, PP, CA, SI, false} where {N, FT, XT, YT, ZT, PP, CA, SI}
...
function WENO(FT::DataType=Float64; 
    ...
    return WENO{N, FT, divergent_branches}(weno_coefficients..., bounds, buffer_scheme, advecting_velocity_scheme)
end
...
Adapt.adapt_structure(to, scheme::WENO{N, FT, XT, YT, ZT, PP, CA, SI, D}) where {N, FT, XT, YT, ZT, PP, CA, SI, D} =
     WENO{N, FT, D}(Adapt.adapt(to, scheme.coeff_xᶠᵃᵃ), Adapt.adapt(to, scheme.coeff_xᶜᵃᵃ),
...
on_architecture(to, scheme::WENO{N, FT, XT, YT, ZT, PP, CA, SI, D}) where {N, FT, XT, YT, ZT, PP, CA, SI, D} =
    WENO{N, FT, D}(on_architecture(to, scheme.coeff_xᶠᵃᵃ), on_architecture(to, scheme.coeff_xᶜᵃᵃ),
