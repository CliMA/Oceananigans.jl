...
@inline interior_parent_x_indices(loc, grid) = interior_parent_indices(loc, topology(grid, 1), grid.Nx, grid.Hx)
@inline interior_parent_y_indices(loc, grid) = interior_parent_indices(loc, topology(grid, 2), grid.Ny, grid.Hy)
@inline interior_parent_z_indices(loc, grid) = interior_parent_indices(loc, topology(grid, 3), grid.Nz, grid.Hz)
