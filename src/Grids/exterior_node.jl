...
@inline exterior_node(i, j, k, grid) = false
@inline exterior_node(i, j, k, grid::XBoundedGrid) = (i < 1) | (i > grid.Nx)
@inline exterior_node(i, j, k, grid::YBoundedGrid) = (j < 1) | (j > grid.Ny)
@inline exterior_node(i, j, k, grid::ZBoundedGrid) = (k < 1) | (k > grid.Nz)

@inline exterior_node(i, j, k, grid::XYBoundedGrid) = (i < 1) | (i > grid.Nx) | (j < 1) | (j > grid.Ny)
@inline exterior_node(i, j, k, grid::XZBoundedGrid) = (i < 1) | (i > grid.Nx) | (k < 1) | (k > grid.Nz)
@inline exterior_node(i, j, k, grid::YZBoundedGrid) = (j < 1) | (j > grid.Ny) | (k < 1) | (k > grid.Nz)

@inline exterior_node(i, j, k, grid::FullBoundedGrid) = (i < 1) | (i > grid.Nx) |
                                                        (j < 1) | (j > grid.Ny) |
                                                        (k < 1) | (k > grid.Nz)

@inline exterior_node(LX, LY, LZ, i, j, k, grid) = exterior_node(i, j, k, grid)
@inline peripheral_node(LX, LY, LZ, i, j, k, grid) = exterior_node(i, j, k, grid)

@inline exterior_node(::Face, LY, LZ, i, j, k, grid) = exterior_node(i, j, k, grid) & exterior_node(i-1, j, k, grid)
@inline exterior_node(LX, ::Face, LZ, i, j, k, grid) = exterior_node(i, j, k, grid) & exterior_node(i, j-1, k, grid)
@inline exterior_node(LX, LY, ::Face, i, j, k, grid) = exterior_node(i, j, k, grid) & exterior_node(i, j, k-1, grid)
...
@inline peripheral_node(::Face, LY, LZ, i, j, k, grid) = exterior_node(i, j, k, grid) | exterior_node(i-1, j, k, grid)
@inline peripheral_node(LX, ::Face, LZ, i, j, k, grid) = exterior_node(i, j, k, grid) | exterior_node(i, j-1, k, grid)
@inline peripheral_node(LX, LY, ::Face, i, j, k, grid) = exterior_node(i, j, k, grid) | exterior_node(i, j, k-1, grid)
