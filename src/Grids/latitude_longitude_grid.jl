...
struct LatitudeLongitudeGrid{FT, TX, TY, TZ, M, MY, FX, FY, FZF, FZC, VX, VY, VZ, Arch} <: AbstractUnderlyingGrid{FT, TX, TY, TZ, Arch}
    architecture :: Arch
    Nx :: Int
    Ny :: Int
    Nz :: Int
    ...
    LatitudeLongitudeGrid{TX, TY, TZ}(architecture::Arch,
                                      ...
                                      radius :: FT) where {Arch, FT, TX, TY, TZ,
                                                           FX, FY, FZF, FZC, VX, VY, VZ,
                                                           M, MY} =
    new{FT, TX, TY, TZ, M, MY, FX, FY, FZF, FZC, VX, VY, VZ, Arch}(architecture,
                                                                   Nλ, Nφ, Nz,
                                                                   Hλ, Hφ, Hz,
                                                                   Lλ, Lφ, Lz,
