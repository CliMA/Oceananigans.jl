...
Adapt.adapt_structure(to, grid::LatitudeLongitudeGrid{FT, TX, TY, TZ, M, MY, FX, FY, FZ}) where {FT, TX, TY, TZ, M, MY, FX, FY, FZ} =
    LatitudeLongitudeGrid{FT, TX, TY, TZ, M, MY, FX, FY, FZ,
        ...
        adapt_if_vector(grid.Δλᶠᵃᵃ),
        adapt_if_vector(grid.Δλᶜᵃᵃ),
        adapt_if_vector(grid.λᶠᵃᵃ),
        adapt_if_vector(grid.λᶜᵃᵃ),
        adapt_if_vector(grid.Δφᵃᶠᵃ),
        adapt_if_vector(grid.Δφᵃᶜᵃ),
        adapt_if_vector(grid.φᵃᶠᵃ),
        adapt_if_vector(grid.φᵃᶜᵃ),
        adapt_if_vector(grid.Δzᵃᵃᶠ),
        adapt_if_vector(grid.Δzᵃᵃᶜ),
        adapt_if_vector(grid.zᵃᵃᶠ),
