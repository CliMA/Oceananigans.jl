...
lower_exterior_Δcoordᶜ(topology,        Fi, Hcoord) = [Fi[end - Hcoord + i] - Fi[end - H + i - 1] for i = 1:Hcoord]
...
# generate a stretched coordinate passing the explicit coord faces as vector of function
