...
Adapt.adapt_structure(to, grid::RectilinearGrid{FT, TX, TY, TZ, FX, FY, FZ}) where {FT, TX, TY, TZ, FX, FY, FZ} =
    LatitudeLongitudeGrid{FT, TX, TY, TZ, FX, FY, FZ,
        ...
        adapt_if_vector(to, grid.Δxᶠᵃᵃ),
        adapt_if_vector(to, grid.Δxᶜᵃᵃ),
        adapt_if_vector(to, grid.xᶠᵃᵃ),
        adapt_if_vector(to, grid.xᶜᵃᵃ),
        adapt_if_vector(to, grid.Δyᵃᶠᵃ),
        adapt_if_vector(to, grid.Δyᵃᶜᵃ),
        adapt_if_vector(to, grid.yᵃᶠᵃ),
        adapt_if_vector(to, grid.yᵃᶜᵃ),
