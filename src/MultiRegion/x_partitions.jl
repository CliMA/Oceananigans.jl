...
const FunctionMRO     = MultiRegionObject{<:Tuple{T, Vararg{T}}} where T<:Function
const ArrayMRO{T, N}  = MultiRegionObject{<:Tuple{A, Vararg{A}}} where A<:AbstractArray{T, N} where {T, N}
