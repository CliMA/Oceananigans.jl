...
@inline νᶠᶠᶜ(i, j, k, grid, clock, ν::AbstractArray) = ℑxyᶠᶠᵃ(i, j, k, grid, ν)
@inline νᶠᶜᶠ(i, j, k, grid, clock, ν::AbstractArray) = ℑxzᶠᵃᶠ(i, j, k, grid, ν)
@inline νᶜᶠᶠ(i, j, k, grid, clock, ν::AbstractArray) = ℑyzᵃᶠᶠ(i, j, k, grid, ν)
