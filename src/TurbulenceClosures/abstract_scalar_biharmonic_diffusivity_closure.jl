...
@inline νᶜᶜᶜ(i, j, k, grid, clo::ASBD, K, clock, fields) = νᶜᶜᶜ(i, j, k, grid, ccc, viscosity(clo, K), clock, fields) 
@inline νᶠᶠᶜ(i, j, k, grid, clo::ASBD, K, clock, fields) = νᶠᶠᶜ(i, j, k, grid, ccc, viscosity(clo, K), clock, fields)
@inline νᶠᶜᶠ(i, j, k, grid, clo::ASBD, K, clock, fields) = νᶠᶜᶠ(i, j, k, grid, ccc, viscosity(clo, K), clock, fields)
@inline νᶜᶠᶠ(i, j, k, grid, clo::ASBD, K, clock, fields) = νᶜᶠᶠ(i, j, k, grid, ccc, viscosity(clo, K), clock, fields)

@inline κᶠᶜᶜ(i, j, k, grid, clo::ASBD, K, id, clock, fields) = κᶠᶜᶜ(i, j, k, grid, ccc, diffusivity(clo, K, id), clock, fields)
@inline κᶜᶠᶜ(i, j, k, grid, clo::ASBD, K, id, clock, fields) = κᶜᶠᶜ(i, j, k, grid, ccc, diffusivity(clo, K, id), clock, fields)
@inline κᶜᶜᶠ(i, j, k, grid, clo::ASBD, K, id, clock, fields) = κᶜᶜᶠ(i, j, k, grid, ccc, diffusivity(clo, K, id), clock, fields)
