...
@inline ∂ⱼ_τ₁ⱼ(i, j, k, grid, clock, closure::AnisotropicBiharmonicDiffusivity, U, args...) = (
...
@inline function ∇_dot_qᶜ(i, j, k, grid, clock, closure::AnisotropicBiharmonicDiffusivity,
