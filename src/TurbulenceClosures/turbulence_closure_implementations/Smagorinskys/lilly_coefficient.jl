...
"""
LillyCoefficient(FT=Oceananigans.defaults.float_type; smagorinsky=0.16, reduction_factor=1) =
...
Lilly, D. K. "The representation of small-scale turbulence in numerical simulation experiments."
    NCAR Manuscript No. 281, 0, (1966)
"""
function SmagorinskyLilly(time_discretization=ExplicitTimeDiscretization(), FT=Oceananigans.defaults.float_type; C=0.16, Cb=1, Pr=1)
