...
* νᶜ (Float64 parameter): Convective adjustment viscosity.
* Ri₀ν (Float64 parameter): Ri threshold for decreasing viscosity.
* Riᵟν (Float64 parameter): Ri-width over which viscosity decreases to 0.
...
* Ri₀κ (Float64 parameter): Ri threshold for decreasing viscosity.
* Riᵟκ (Float64 parameter): Ri-width over which diffusivity decreases to 0.
"""
