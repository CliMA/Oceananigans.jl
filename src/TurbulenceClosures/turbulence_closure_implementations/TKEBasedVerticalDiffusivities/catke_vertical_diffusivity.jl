...
- `maximum_tracer_diffusivity`/`maximum_viscosity`/`maximum_tke_diffusivity`: Maximum value for tracer, momentum,
                                                                              and TKE diffusivities respectively.
                                                                              Used to clip the diffusivity when/if
                                                                              CATKE predicts diffusivities that are
                                                                              too large. Default: `Inf`.
