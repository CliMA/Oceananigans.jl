...
# 1D Fields (3D, 2D and 1D indexing)
...
@propagate_inbounds Base.getindex(r::YZReducedField, i, j)    = getindex(r.data, i, 1, 1)
@propagate_inbounds Base.getindex(r::XZReducedField, i, j)    = getindex(r.data, 1, j, 1)
@propagate_inbounds Base.getindex(r::XYReducedField, j, k)    = getindex(r.data, 1, 1, k)
...
@propagate_inbounds Base.setindex!(r::YZReducedField, v, i, k)    = setindex!(r.data, v, i, 1, 1)
@propagate_inbounds Base.setindex!(r::XZReducedField, v, i, j)    = setindex!(r.data, v, 1, j, 1)
@propagate_inbounds Base.setindex!(r::XYReducedField, v, i, k)    = setindex!(r.data, v, 1, 1, k)
