...
import Oceananigans.Architectures: on_architecture, AbstractSerialArchitecture
...
on_architecture(arch::AbstractSerialArchitecture, field::AbstractField{LX, LY, LZ}) where {LX, LY, LZ} =
