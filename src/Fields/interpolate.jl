@inline fractional_x_index(x, ::Center, grid::RegularRectilinearOrthogonalGrid) = @inbounds (x - grid.xC[1]) / grid.Δx
@inline fractional_x_index(x, ::Face, grid::RegularRectilinearOrthogonalGrid) = @inbounds (x - grid.xF[1]) / grid.Δx

@inline fractional_y_index(y, ::Center, grid::RegularRectilinearOrthogonalGrid) = @inbounds (y - grid.yC[1]) / grid.Δy
@inline fractional_y_index(y, ::Face, grid::RegularRectilinearOrthogonalGrid) = @inbounds (y - grid.yF[1]) / grid.Δy

@inline fractional_z_index(z, ::Center, grid::RegularRectilinearOrthogonalGrid) = @inbounds (z - grid.zC[1]) / grid.Δz
@inline fractional_z_index(z, ::Face, grid::RegularRectilinearOrthogonalGrid) = @inbounds (z - grid.zF[1]) / grid.Δz

"""
    fractional_indices(x, y, z, loc, grid::RegularRectilinearOrthogonalGrid)
...
grid points.
"""
@inline function fractional_indices(x, y, z, loc, grid::RegularRectilinearOrthogonalGrid)
