...
@testset "Boundary conditions" begin
    ...
    @testset "Field and coordinate boundary conditions" begin
        ...
        ppp_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 1, 1), topology=ppp_topology)
        ...
        ppb_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 1, 1), topology=ppb_topology)
        ...
        pbb_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 1, 1), topology=pbb_topology)
        ...
        bbb_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 1, 1), topology=bbb_topology)
