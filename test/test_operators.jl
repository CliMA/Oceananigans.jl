...
function test_δxc2f(mm::ModelMetadata, g::Grid)
    T = typeof(g.V)
    f = CellField(mm, g, mm.float_type)
    f.data .= rand(T, size(g))

    δxf1 = δˣc2f(f.data)

    δxf2 = FaceFieldX(mm, g, mm.float_type)
    δx!(g, f, δxf2)
...
function test_δxf2c(mm::ModelMetadata, g::Grid)
    T = typeof(g.V)
    f = FaceFieldX(mm, g, mm.float_type)
    f.data .= rand(T, size(g))

    δxf1 = δˣf2c(f.data)

    δxf2 = CellField(mm, g, mm.float_type)
    δx!(g, f, δxf2)
...
function test_δyc2f(mm::ModelMetadata, g::Grid)
    ...
    δyf2 = FaceFieldY(mm, g, mm.float_type)
    δy!(g, f, δyf2)
...
function test_δyf2c(mm::ModelMetadata, g::Grid)
    T = typeof(g.V)
    f = FaceFieldY(mm, g, mm.float_type)
    f.data .= rand(T, size(g))

    δyf1 = δʸf2c(f.data)

    δyf2 = CellField(mm, g, mm.float_type)
    δy!(g, f, δyf2)
...
function test_δzc2f(mm::ModelMetadata, g::Grid)
    ...
    δzf2 = FaceFieldZ(mm, g, mm.float_type)
    δz!(g, f, δzf2)
...
function test_δzf2c(mm::ModelMetadata, g::Grid)
    T = typeof(g.V)
    f = FaceFieldZ(mm, g, mm.float_type)
    f.data .= rand(T, size(g))

    δzf1 = δᶻf2c(f.data)

    δzf2 = CellField(mm, g, mm.float_type)
    δz!(g, f, δzf2)
...
function test_avgxc2f(mm::ModelMetadata, g::Grid)
    ...
    avgxf2 = FaceFieldX(mm, g, mm.float_type)
    avgx!(g, f, avgxf2)
...
function test_avgxf2c(mm::ModelMetadata, g::Grid)
    ...
    avgxf2 = CellField(mm, g, mm.float_type)
    avgx!(g, f, avgxf2)
...
function test_avgyc2f(mm::ModelMetadata, g::Grid)
    ...
    avgyf2 = FaceFieldY(mm, g, mm.float_type)
    avgy!(g, f, avgyf2)
...
function test_avgyf2c(mm::ModelMetadata, g::Grid)
    ...
    avgyf2 = CellField(mm, g, mm.float_type)
    avgy!(g, f, avgyf2)
...
function test_avgzc2f(mm::ModelMetadata, g::Grid)
    ...
    avgzf2 = FaceFieldZ(mm, g, mm.float_type)
    avgz!(g, f, avgzf2)
...
function test_avgzf2c(mm::ModelMetadata, g::Grid)
    ...
    avgzf2 = CellField(mm, g, mm.float_type)
    avgz!(g, f, avgzf2)
...
function test_divf2c(mm::ModelMetadata, g::Grid)
    ...
    fx = FaceFieldX(mm, g, mm.float_type)
    fy = FaceFieldY(mm, g, mm.float_type)
    fz = FaceFieldZ(mm, g, mm.float_type)
    ...
    div2 = CellField(mm, g, mm.float_type)
...
function test_divc2f(mm::ModelMetadata, g::Grid)
    ...
    fx = CellField(mm, g, mm.float_type)
    fy = CellField(mm, g, mm.float_type)
    fz = CellField(mm, g, mm.float_type)
    tmp = OperatorTemporaryFields(mm, g)
    ...
    div2 = FaceFieldX(mm, g, mm.float_type)
    div!(g, fx, fy, fz, div2, tmp)
...
function test_div_flux(mm::ModelMetadata, g::Grid)
    ...
    θ = CellField(mm, g, mm.float_type)
    tmp = OperatorTemporaryFields(mm, g)
    ...
    div_flux2 = CellField(mm, g, mm.float_type)
...
function test_u_dot_grad_u(mm::ModelMetadata, g::Grid)
    ...
    u∇u2 = FaceFieldX(mm, g, mm.float_type)
    u∇u!(g, U, u∇u2, tmp)
...
function test_u_dot_grad_v(mm::ModelMetadata, g::Grid)
    ...
    u∇v2 = FaceFieldY(mm, g, mm.float_type)
    u∇v!(g, U, u∇v2, tmp)
...
function test_u_dot_grad_w(mm::ModelMetadata, g::Grid)
    ...
    u∇w2 = FaceFieldZ(mm, g, mm.float_type)
    u∇w!(g, U, u∇w2, tmp)
...
function test_κ∇²(mm::ModelMetadata, g::Grid)
    ...
    κ∇²T2 = CellField(mm, g, mm.float_type)
...
function test_𝜈∇²u(mm::ModelMetadata, g::Grid)
    ...
    𝜈∇²u2 = FaceFieldX(mm, g, mm.float_type)
...
function test_𝜈∇²v(mm::ModelMetadata, g::Grid)
    ...
    𝜈∇²v2 = FaceFieldY(mm, g, mm.float_type)
...
function test_𝜈∇²w(mm::ModelMetadata, g::Grid)
    ...
    𝜈∇²w2 = FaceFieldZ(mm, g, mm.float_type)
...
function test_∇²_ppn(mm::ModelMetadata, g::Grid)
    ...
    ∇²f2 = CellField(mm, g, mm.float_type)
    ∇²_ppn!(g, f, ∇²f2)
