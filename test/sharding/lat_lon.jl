include(joinpath(@__DIR__, "..", "setup", "sharding_test_utils.jl"))
...
@testset "Test sharded LatitudeLongitudeGrid simulations..." begin
    ...
    run(`$(Base.julia_cmd()) --project=$(Base.active_project()) --check-bounds=auto -O0 $(joinpath(@__DIR__, "..", "setup", "run_sharding_tests.jl"))`)
