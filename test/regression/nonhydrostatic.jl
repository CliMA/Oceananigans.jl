...
include(joinpath(@__DIR__, "..", "setup", "regression_tests", "thermal_bubble_regression_test.jl"))
include(joinpath(@__DIR__, "..", "setup", "regression_tests", "rayleigh_benard_regression_test.jl"))
include(joinpath(@__DIR__, "..", "setup", "regression_tests", "ocean_large_eddy_simulation_regression_test.jl"))
