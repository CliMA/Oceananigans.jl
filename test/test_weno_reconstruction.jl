...
@testset "WENO reconstruction" begin
    ...
    @testset "ENO reconstruction weights" begin
        ...
        @testset "WENO-7" begin
            ...
            @test eno_coefficient(4, -1) == [25//12, -23//12,  13//12, -1//4 ]
            @test eno_coefficient(4,  0) == [ 1//4,   13//12,  -5//12,  1//12]
            @test eno_coefficient(4,  1) == [-1//12,   7//12,   7//12, -1//12]
            @test eno_coefficient(4,  -2) == [ 1//12,  -5//12,  13//12,  1//4 ]
            @test eno_coefficient(4,  3) == [-1//4,   13//12, -23//12, 25//12]
        end
        ...
        @testset "WENO-9" begin
            ...
            @test eno_coefficient(5, -1) == [ 137//60, -163//60, 137//60,  -21//20,   1//5 ]
            @test eno_coefficient(5,  0) == [   1//5,    77//60, -43//60,   17//60,  -1//20]
            @test eno_coefficient(5,  1) == [  -1//20,    9//20,  47//60,  -13//60,   1//30]
            @test eno_coefficient(5,  2) == [   1//30,  -13//60,  47//60,    9//20,  -1//20]
            @test eno_coefficient(5,  3) == [  -1//20,   17//60, -43//60,   77//60,   1//5 ]
            @test eno_coefficient(5,  4) == [   1//5,   -21//20, 137//60, -163//60, 137//60]
        end
    end
