...
include(joinpath(@__DIR__, "..", "setup", "reactant_correctness_utils.jl"))
...
@testset "Reactant correctness" begin
    ...
    # Get vanilla architecture from TEST_ARCHITECTURE env var (set by setup/reactant_test_utils.jl)
    ...
    @testset "fill_halo_regions! correctness" begin
        ...
        # TripolarGrid tests commented out: Reactant MLIR segfaults
    ...
    # HydrostaticFreeSurfaceModel time-stepping tests commented out:
