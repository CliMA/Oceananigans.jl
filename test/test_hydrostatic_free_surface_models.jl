...
using Oceananigans.Models.HydrostaticFreeSurfaceModels: VectorInvariant, PrescribedVelocityFields, PrescribedTracer
...
@testset "Hydrostatic free surface Models" begin
    ...
    for arch in archs
        ...
        #####
        ##### PrescribedTracer tests
        #####

        @testset "Basic PrescribedTracer construction and non-stepping [$arch]" begin
