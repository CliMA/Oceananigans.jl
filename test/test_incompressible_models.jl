@testset "Models" begin
    ...
    for topo in topos
        @testset "$topo model construction" begin
            ...
            for arch in archs, FT in float_types
                ...
                grid = RegularRectilinearOrthogonalGrid(FT, topology=topo, size=(16, 16, 2), extent=(1, 2, 3))
    ...
    @testset "Adjustment of halos in IncompressibleModel constructor" begin
        ...
        default_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 2, 3))
        funny_grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 2, 3), halo=(1, 3, 4))
    ...
    @testset "Model construction with single tracer and nothing tracer" begin
        ...
        for arch in archs
            grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 1), extent=(1, 2, 3))
    ...
    @testset "Non-dimensional model" begin
        ...
        for arch in archs, FT in float_types
            grid = RegularRectilinearOrthogonalGrid(FT, size=(16, 16, 2), extent=(3, 2, 1))
