...
@testset "Biogeochemistry" begin
    ...
    for bgc in (MinimalDiscreteBiogeochemistry, MinimalContinuousBiogeochemistry), 
        ...
        grid in (RectilinearGrid(arch; size = (2, 2, 2), extent = (2, 2, 2)), 
                 ...
                 LatitudeLongitudeGrid(arch; topology = (Periodic, Flat, Bounded), size = (5, 5), longitude = (-30, 50), z = (-2, 0)),
                 LatitudeLongitudeGrid(arch; topology = (Flat, Bounded, Bounded), size = (5, 5), latitude = (0, 40), z = (-2, 0)),
