...
@test MovieMaker(fig, update_plot; filename, format="mp4", framerate=12, compression=20) isa MovieMaker
@test MovieMaker(fig, update_plot) isa MovieMaker
maker = MovieMaker(fig, update_plot)
@test maker.figure isa Figure
@test maker.func isa Function
