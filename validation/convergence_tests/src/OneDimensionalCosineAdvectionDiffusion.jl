...
function run_test(; Nx, Δt, stop_iteration, U = 1, κ = 1e-4,
    ...
    grid = RegularRectilinearOrthogonalGrid(topology=topo, size=(Nx, 1, 1), halo=(3, 3, 3); domain...)
    ...
    ygrid = RegularRectilinearOrthogonalGrid(topology=topo, size=(1, Nx, 1), halo=(3, 3, 3); ydomain...)
    ...
    zgrid = RegularRectilinearOrthogonalGrid(topology=topo, size=(1, 1, Nx), halo=(3, 3, 3); zdomain...)
