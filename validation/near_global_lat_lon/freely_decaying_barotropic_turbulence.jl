...
<<<<<<< HEAD:validation/lat_lon_barotropic_turbulence/freely_decaying_barotropic_turbulence.jl
                                    architecture = GPU(),
                                    advection = WENO5(),
=======
>>>>>>> main:validation/near_global_lat_lon/freely_decaying_barotropic_turbulence.jl
