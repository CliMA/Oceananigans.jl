...
immersed_model = HydrostaticFreeSurfaceModel(; grid=grid, closure=closure, immersed_boundary=solid, model_kwargs...)
...
diffusion_time_scale = model.grid.Δz^2 / model.closure.κz.c
