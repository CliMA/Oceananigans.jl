...
```jldoctest particles
grid = RegularRectilinearOrthogonalGrid(size=(10, 10, 10), extent=(1, 1, 1));
...
├── grid: RegularRectilinearOrthogonalGrid{Float64, Periodic, Periodic, Bounded}(Nx=10, Ny=10, Nz=10)
├── tracers: (:T, :S)
