...
julia> grid = RegularRectilinearOrthogonalGrid(size=(16, 16, 16), extent=(1, 1, 1), topology=topology);
...
├── grid: RegularRectilinearOrthogonalGrid{Float64, Periodic, Periodic, Bounded}(Nx=16, Ny=16, Nz=16)
├── tracers: (:T, :S)
