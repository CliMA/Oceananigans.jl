...
<style>
.oceananigans-paper-timeline {
  margin: 1.5rem 0 2rem 0;
  padding: 1rem 1.25rem 0.75rem 1.25rem;
  border: 1px solid var(--vp-c-divider);
  border-radius: 14px;
  background: linear-gradient(180deg, color-mix(in srgb, var(--vp-c-brand-1) 8%, transparent), transparent 65%);
}

.oceananigans-paper-timeline-title {
  margin: 0 0 0.2rem 0;
  font-size: 0.95rem;
  font-weight: 600;
...
.oceananigans-paper-timeline-subtitle {
  margin: 0 0 0.8rem 0;
  font-size: 0.8rem;
  color: var(--vp-c-text-2);
}

.oceananigans-paper-bars {
  display: flex;
  align-items: end;
  gap: 0.7rem;
  min-height: 12rem;
...
.oceananigans-paper-count {
  font-size: 0.75rem;
  color: var(--vp-c-text-2);
}

.oceananigans-paper-bar {
  width: 100%;
  max-width: 2.6rem;
  min-height: 0.35rem;
  border-radius: 6px 6px 0 0;
  background: linear-gradient(180deg, var(--vp-c-brand-1), var(--vp-c-brand-3));
  box-shadow: 0 0 0 1px color-mix(in srgb, var(--vp-c-brand-1) 18%, transparent);
}

.oceananigans-paper-year {
  font-size: 0.75rem;
  color: var(--vp-c-text-2);
}
</style>

<div class="oceananigans-paper-timeline">
  <p class="oceananigans-paper-timeline-title">Papers per year</p>
  <p class="oceananigans-paper-timeline-subtitle">83 verified papers and preprints currently listed</p>
  <div class="oceananigans-paper-bars">
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">2</div>
      <div class="oceananigans-paper-bar" style="height: 6.25%;"></div>
      <div class="oceananigans-paper-year">2020</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">5</div>
      <div class="oceananigans-paper-bar" style="height: 15.625%;"></div>
      <div class="oceananigans-paper-year">2021</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">5</div>
      <div class="oceananigans-paper-bar" style="height: 15.625%;"></div>
      <div class="oceananigans-paper-year">2022</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">4</div>
      <div class="oceananigans-paper-bar" style="height: 12.5%;"></div>
      <div class="oceananigans-paper-year">2023</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">8</div>
      <div class="oceananigans-paper-bar" style="height: 25%;"></div>
      <div class="oceananigans-paper-year">2024</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">32</div>
      <div class="oceananigans-paper-bar" style="height: 100%;"></div>
      <div class="oceananigans-paper-year">2025</div>
    </div>
    <div class="oceananigans-paper-bar-group">
      <div class="oceananigans-paper-count">27</div>
      <div class="oceananigans-paper-bar" style="height: 84.375%;"></div>
      <div class="oceananigans-paper-year">2026</div>
    </div>
  </div>
</div>
...
1. de la Calle, E. and García, C. (2025) [Evaluation of Juliana Tool: A translator for Julia’s CUDA.jl code into KernelAbstraction.jl](https://doi.org/10.1016/j.future.2025.107813), _Future Generation Computer Systems_, **171**, 107813. DOI: [10.1016/j.future.2025.107813](https://doi.org/10.1016/j.future.2025.107813)
