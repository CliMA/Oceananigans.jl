...
model_setup_pages = [
    ...
    "BuoyancyModels and equation of state" => "model_setup/buoyancy_and_equation_of_state.md",
...
physics_pages = [
    ...
    "BuoyancyModels model and equations of state" => "physics/buoyancy_and_equations_of_state.md",
