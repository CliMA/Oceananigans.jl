...
function fast_inv_cuda(a::Float64)
    ...
    # This instruction chops off last 32 bits of mantissa and computes inverse
    ...
    # Approximate the missing 32 bits of mantissa with a single cubic iteration
    e = fma(inv_a, -a, 1.0)
    e = fma(e, e, e)
...
function fast_inv_cuda(a::Float32)
    ...
    # hence for subnormal inputs it returns Inf and for large numbers whose
    # reciprocal is subnormal it underflows to 0.0.
