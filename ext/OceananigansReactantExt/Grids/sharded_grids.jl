...
function Oceananigans.LatitudeLongitudeGrid(arch::ShardedDistributed,
    ...
    return LatitudeLongitudeGrid{TX, TY, TZ}(arch,
                                             ...
                                             Reactant.to_rarray(grid.Δλᶠᵃ; sharding=λmetric_sharding),
                                             Reactant.to_rarray(grid.Δλᶜᵃ; sharding=λmetric_sharding),
                                             Reactant.to_rarray(grid.λᶠᵃᵃ; sharding=λsharding),
                                             Reactant.to_rarray(grid.λᶜᵃᵃ; sharding=λsharding),
                                             Reactant.to_rarray(grid.Δφᵃᶠ; sharding=φmetric_sharding),
                                             Reactant.to_rarray(grid.Δφᵃᶜ; sharding=φmetric_sharding),
