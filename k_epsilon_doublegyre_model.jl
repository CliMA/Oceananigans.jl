...
#%%
filename = "doublegyre_30Cwarmflushbottom10_relaxation_8days_zWENO5_TKEDissipationVerticalDiffusivity_100years"
...
uwbar_zonal = Average(uw, dims=1)
vwbar_zonal = Average(vw, dims=1)
wTbar_zonal = Average(wT, dims=1)
wSbar_zonal = Average(wS, dims=1)

outputs = (; u, v, w, T, S, ρ, ρᶠ, ∂ρ∂z, ∂²ρ∂z², N², uw, vw, wT, wS)
zonal_outputs = (; ubar_zonal, vbar_zonal, wbar_zonal, Tbar_zonal, Sbar_zonal, ρbar_zonal, uwbar_zonal,vwbar_zonal, wTbar_zonal, wSbar_zonal)
