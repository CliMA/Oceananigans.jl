...
include("ForcedFlowVerification.jl")

free_slip_simulation_files = glob("forced_free_slip*.jld2")

errors = ForcedFlowVerification.compute_errors(ForcedFlowVerification.FreeSlip.u, 
                                               free_slip_simulation_files...)

sizes = ForcedFlowVerification.extract_sizes(free_slip_simulation_files...)
