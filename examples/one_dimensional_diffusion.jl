...
#
# Below, we build a rectilinear grid with 128 grid points in the `z`-direction, where `z`
# spans from `z = -0.5` to `z = 0.5`,

grid = RegularRectilinearOrthogonalGrid(size=(1, 1, 128), x=(0, 1), y=(0, 1), z=(-0.5, 0.5))
