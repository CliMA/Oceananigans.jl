...
ax_v = Axis(fig[2, 2]; title = "along-slope velocity", axis_kwargs...)

heatmap!(ax_ω, xω, zω, ω_y, colorrange = (-0.015, +0.015), colormap = :balance)

heatmap!(ax_v, xv, zv, total_v, colorrange = (-V∞, +V∞), colormap = :balance)
