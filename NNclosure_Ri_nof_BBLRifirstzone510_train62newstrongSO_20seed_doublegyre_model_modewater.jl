...
using Oceananigans
include("NN_closure_global_Ri_nof_BBLRifirstzone510_train62newstrongSO_20seed.jl")
...
filename = "doublegyre_30Cwarmflushbottom10_relaxation_30days_modewater_zWENO5_NN_closure_NDE5_Ri_BBLRifirztzone510train62newstrongSO_20seed_QT$(Qᵀ_mode)"
...
@inline surface_T_flux(x, y, t, T) = μ_T * Δz * (T - T_ref(y)) + Qᵀ_subpolar(x, y, t)
